...
class Register extends React.Component<PropsWithStyles, State> {
            ...
            {this.state.continue ? <DialogContent className={classNames(this.props.classes.registerDivContinue)}>
                ...
                <div>
                    ...
                    <DialogActions>
                        ...
                        <ButtonBase onClick={this.handleContinue}>Continue</ButtonBase>
                    </DialogActions>
                </div>}
        </Dialog>
        );
